...
```
Almost done. Lastly, you need to add code to capture the JWT. Search for `echoMessages: file` and you will find the variable containing the list of headers sent to Ably. Right below that, add this line:
```js
